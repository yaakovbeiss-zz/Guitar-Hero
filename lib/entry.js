...
document.addEventListener('DOMContentLoaded', ()=> {
    ...
    let generator = new SoundGenerator(`https://s3.us-east-2.amazonaws.com/guitar-hero/iloverockandrollupdated/0+`,
      `https://s3.us-east-2.amazonaws.com/guitar-hero/iloverockandrollupdated/iloverockandrollbackingtrack.mp3`);

    generator.generateSounds(85, ()=> {
